    ...
    >
      <el-tabs type="border-card">
        <el-tab-pane>
          ...
          >
            <icon-svg icon-class="dashboard" />华东区域
          </span>
        ...
        <el-tab-pane>
          ...
          >
            <icon-svg icon-class="charts" />华南区域
          </span>
          <china-tabs-table :toggleData="toggleData"></china-tabs-table>
        </el-tab-pane>
        <el-tab-pane>
        ...
        <el-tab-pane>
          ...
          >
            <icon-svg icon-class="permission" />华北区域
          </span>
          <china-tabs-table :toggleData="toggleData"></china-tabs-table>
        </el-tab-pane>
        <el-tab-pane>
        ...
        <el-tab-pane>
          <span
            slot="label"
            @click="toggleTabs('southwestChina')"
          >
            <icon-svg icon-class="error" />西南地区
          </span>
          <china-tabs-table :toggleData="toggleData"></china-tabs-table>
        </el-tab-pane>
        <el-tab-pane>
          <span
            slot="label"
            @click="toggleTabs('northeastChina')"
          >
            <icon-svg icon-class="pay" />东北地区
          </span>
          <china-tabs-table :toggleData="toggleData"></china-tabs-table>
        </el-tab-pane>
        <el-tab-pane>
          <span
            slot="label"
            @click="toggleTabs('specialareaChina')"
          >
            <icon-svg icon-class="pay" />台港澳地区
          </span>
          <china-tabs-table :toggleData="toggleData"></china-tabs-table>
        </el-tab-pane>
      </el-tabs>
